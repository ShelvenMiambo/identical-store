...
export default function CheckoutPage({ cartItems, onClearCart }: CheckoutPageProps) {
  ...
  const onSubmit = async (data: CheckoutFormData) => {
    ...
    try {
      // TODO: Create order and integrate with PaySuite
      // const response = await apiRequest("POST", "/api/checkout", { ...data, items: cartItems });
      // const paymentUrl = response.checkout_url;
      // window.location.href = paymentUrl;

      toast({
        title: "Pedido criado com sucesso!",
        description: "Será redirecionado para o pagamento...",
      });
