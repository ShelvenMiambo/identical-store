        ...
        <div>
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-6 mb-8">
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg sm:text-2xl font-bold break-words">{formatCurrency(totalRevenue)}</div>
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg sm:text-2xl font-bold break-words">{formatCurrency(confirmedRevenue)}</div>
                        <p className="text-xs text-muted-foreground mt-1">
                ...
                <Card>
                    ...
                    <CardContent>
                        <div className="text-lg sm:text-2xl font-bold break-words">{formatCurrency(averageOrderValue)}</div>
                        <p className="text-xs text-muted-foreground mt-1">
                            Por pedido
                        </p>
                    </CardContent>
