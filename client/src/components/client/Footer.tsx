...
/* ── Ícones SVG para redes sociais não disponíveis no lucide ── */
const InstagramIcon = () => (
          ...
          <div className="space-y-4">
            ...
            <div className="flex gap-3 flex-wrap">
              ...
              <a
                ...
                className="hover-elevate active-elevate-2 p-2 rounded-md text-muted-foreground hover:text-foreground transition-colors"
